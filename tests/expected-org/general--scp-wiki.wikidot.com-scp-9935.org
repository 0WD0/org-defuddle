...
:PROPERTIES:
:DESCRIPTION: The SCP Foundation's 'top-secret' archives, declassified for your enjoyment.
:LANGUAGE: en
:WORD_COUNT: 233
:END:
...
*Description:* SCP-9935 is an anomalous baseball game between the Indianapolis Hoosiers and the Washington Nationals [fn:1] that began on October 5th, 1889 and is still ongoing. Neither team has scored a run since the original game became tied in the 35th inning. Both teams folded before the start of the next season [fn:2].

Jack Glasscock [fn:3], the Hoosiers shortstop and team captain, provided the following account of the early innings.
...
[fn:2] The fact that both teams folded was not unusual, as both had been mired in multiple seasons of poor performance.
