...
:IMAGE: https://maggieappleton.com/og/xanadu-patterns.png
:LANGUAGE: en
:WORD_COUNT: 2417
:END:

When it comes to visionary, before-its-time software, it’s hard to find a better archetype than Ted Nelson’s [[https://en.wikipedia.org/wiki/Project_Xanadu][Project Xanadu]].
...
It’s hard to read the word /hypertext/ in 2021 5ya and not believe its synonymous with the system Tim Berners-Lee built in 1989 37ya – the World Wide Web that became so much more than linked text on digital screens. The version of hypertext you are reading this on is the only hypertext most of us have ever known.

And yet the idea of hypertext predates Berners-Lee by two decades. The term was coined in 1963 63ya by none other than Ted Nelson as part of a much larger vision; one small brick in the grand Xanadu dream mansion. [fn:2]
...
Ted hoped Xanadu would be a medium for “ [[https://xanadu.com.au/ted/XUsurvey/xuDation.html][serious electronic literature]] ” – a paradigm shift that would free us from the material constraints of paper. His vision was the first to meaningfully consider how storing information in digital bits could reconfigure the way we read, write, cite, and share words.

Xanadu’s failure to mature into a widespread, useable commercial product is great fodder a [[https://www.wired.com/1995/06/xanadu/][dramatic cover story]]. One fuelled by the noticeably combative language in Xanadu’s [[https://xanadu.com/][documentation]]:
...
[[https://maggieappleton.com/pattern-languages][Pattern Languages]] are sets of flexible, reusable solutions to common design problems.

They come from the land of architects: the software developers of the material world. Namely, the architect [[https://en.wikipedia.org/wiki/Christopher_Alexander][Christopher Alexander]], whose philosophy of constructing vibrant and humane living space escaped the confines of urban planning and infused the world of software design in the late 1980’s.

In their book [[https://en.wikipedia.org/wiki/A_Pattern_Language][A Pattern Language]], Alexander defined 253 architectural patterns for designing cities, towns, and homes. These became the example patterns for writing patterns. Each one is composed of a context, problem, example, and solution.

[[https://maggieappleton.com/_astro/patterns.D8-ibnKY_Z2ngng6.webp][A Pattern Language]]
...
We’ve found ways to adapt to this; Venkatesh Rao has a compelling exploration of how we’ve developed a [[https://www.ribbonfarm.com/2009/07/01/the-rhetoric-of-the-hyperlink/][rhetoric of hyperlinking]] to hint at where people are headed. Most browsers will do this more explicitly by showing you a URL preview, but they tuck them into the far corner in tiny text:

[[https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_auto:good,w_1200/v1623585337/maggieappleton.com/notes/xanadu/hover-preview-url_shrink_kxvwtp.png][URL hover previews showing in the left hand corner of page]]
...
[[https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_auto:good,w_1200/v1623916915/maggieappleton.com/notes/xanadu/xanadu_au17yq_shrink_tqkdxs.png][One of the original UI mockups for a Xanadoc with visible links between text blocks]]
...
*Hover previews* are when you can see a preview of the page you’re headed to when you hover over a link. It’s usually an excerpt that gives you the page title, the first few lines of text, and sometimes an image. Wikipedia was one of the first major sites to [[https://blog.wikimedia.org/2018/04/18/how-we-designed-page-previews-for-wikipedia/][add these]] in 2018 8ya.

[[https://res.cloudinary.com/dg3gyk0gu/image/upload/c_scale,f_auto,q_auto:good,w_1000/v1592343673/maggieappleton.com/notes/Screenshot_-_2020-06-16_20.49.44.png][Wikipedia's interface showing one of the hover previews that appear over links]]

Wikipedia's interface showing one of the hover previews that appear over links

Hover previews have also become popular in the [[https://maggieappleton.com/garden-history][Digital Gardening]] community as a way to help visitors quickly navigate through collections of public notes and essays that are deeply interlinked. [[https://notes.andymatuschak.org/][Andy Matuschak]] and [[https://www.gwern.net/index][Gwern Branwen]] are two gardeners with good examples of how these work in action.

[[https://res.cloudinary.com/dg3gyk0gu/image/upload/c_scale,f_auto,q_auto:good,w_1000/v1592343501/maggieappleton.com/notes/Screenshot_2020-06-16_at_22.38.06.png][Andy Matuschak's notes website featuring hover link previews]]

Andy Matuschak's notes website featuring hover link previews

Similar to hover previews, *unfurls* are the preview cards that automagically appear when you paste a link into Twitter, Facebook, Notion, Miro, or any other richly-featured web app. If I paste a link to this great article on [[https://www.cjr.org/special_report/building-honest-internet-public-interest.php][building a more honest internet]] into a Tweet or Notion document, it automagically displays the feature image, title, and byline without any extra effort from me:

[[https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_auto:best,w_800/v1623916885/maggieappleton.com/notes/xanadu/tweet-opengraph_o6eecg.jpg][An open graph image preview appearing in a tweet]]

An open graph image preview appearing in a tweet

[[https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_auto:best,w_1000/v1623917579/maggieappleton.com/notes/xanadu/notion-ogpreview_shrink_ckiuyn.png][Open graph previews appear in Notion when you paste a link and select 'Create Bookmark']]

Open graph previews appear in Notion when you paste a link and select 'Create Bookmark'

This system is powered by the [[https://ogp.me/][Open Graph Protocol]] which Facebook introduced in 2010 16ya. This standardised format helps website authors define /metadata/ like titles, descriptions, authors, and images for each of their pages. These are automatically retrieved and “unfurled” when the link is pasted elsewhere on the web.
...
[[https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_auto:good,w_900/v1640076312/maggieappleton.com/notes/xanadu/transclusion_6_shrink_sl0vcb_mtepgz.jpg][Three parallel documents with visible links between them]]
...
The existing prototypes of Xanadu don’t gracefully solve this problem in any way. Some of them – like the 2007 19ya /XanaduSpace/ demo – suggest launching into the disorienting world of 3D paper where documents tower over you like skyscrapers.
...
[[https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_auto:best,w_1100/v1623925818/maggieappleton.com/notes/xanadu/liquid_rrgru8.png][The interface of LiquidText with transpointing between sections of text]]

The interface of LiquidText with transpointing between sections of text

[[https://azlen.me/][Azlen Elza]] managed to craft up this crazy demo inside of their Roam Research database.

*** 4. Transclusion

- [[https://maggieappleton.com/transcopyright-dreams][Transclusion and Transcopyright Dreams]]

*** 5. Bi-Directional Links

- [[https://maggieappleton.com/bidirectionals][A Short History of Bi-Directional Links]]

*** 6. Version Control

In the age of Git, we tend to take version control for granted.

The first version control system dates back to [[https://en.wikipedia.org/wiki/Version_control#History][1975]]. It’s now difficult to imagine programming without it.
...
This paper document design metaphor determined many of the early architectural decisions. URL addresses were set at the /page/ level, rather than the paragraph. Inline images were an afterthought, and even a contentious addition to the spec. [fn:3]
...
Which is the essence of a good pattern language; true patterns evolve naturally within systems, and are found rather than crafted. [fn:4]

In the grand scheme of things, 60 years isn’t an extraordinary amount of time to spend solving a problem. It’s about 0.09% of history since humans first started creating symbolic cultural artefacts [fn:5]
...
[fn:1] The word hypothetical is a bit strong. Many versions were built. There is a working demo showcasing a few of its features [[http://xanadu.com/xanademos/MoeJusteOrigins.html][here]]. But there is no active version on the App Store or Product Hunt I can link you to.

[fn:2] While Nelson coined the word, the notion of linked documents goes back to Jorge Luis Borges The Garden of Forking Paths” in 1941 85ya and Vannevar Bush’s Memex machine in 1945 81ya – both significant, named influences for Nelson.

[fn:3] No one seriously considered the possibility of adding videos or animations. The presumption visual images are a impoverished medium for serious intellectual thought is a whole other kettle of fish.

[fn:4] Christopher Alexander’s [[https://en.wikipedia.org/wiki/The_Nature_of_Order][The Nature of Order]] goes deep on this principle

[fn:5] Using [[https://en.wikipedia.org/wiki/Cave_of_La_Pasiega][La Pasiega Cave]] in Spain as a relative marker - 65,000 y.a.
